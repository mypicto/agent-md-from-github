...
from scripts.src.presentation.fetch_controller import FetchController, parse_date


class TestFetchController:
    """Test cases for FetchController."""
    ...
    def test__get_github_token_キーリングから取得_トークンが返される(self):
        ...
        with patch('scripts.src.presentation.fetch_controller.TokenManager') as mock_manager:
    ...
    def test__create_date_range_有効な日付範囲_DateRangeが作成される(self):
        ...
        with patch('scripts.src.presentation.fetch_controller.TimezoneConverter') as mock_converter:
